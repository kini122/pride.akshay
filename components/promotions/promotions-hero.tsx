  ...
  return (
    <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/promotions/hero/concert-event-stage-with-crowd-pink-lighting.jpg')",
          transform: isLoaded ? "scale(1)" : "scale(1.1)",
        }}
      />

      {/* Pink Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-orange-300/50 via-orange-200/40 to-white/20" />
