  ...
  return (
    <section className="relative w-full h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('/corporate/hero/corporate-event-presentation-stage-audience-pink-l.jpg')`,
        }}
      >
        <div className="absolute inset-0 bg-gradient-to-b from-orange-300/60 via-orange-200/50 to-orange-400/70" />
      </div>
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        {/* Main Headline */}
        <h1 className="text-3xl md:text-4xl lg:text-5xl tracking-tight lg:text-6xl tracking-tight lg:text-7xl font-bold text-foreground leading-tight mb-6">
          {isLoaded && (
            <>
