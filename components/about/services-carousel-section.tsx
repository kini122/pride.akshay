...
const services = [
  ...
  },
  {
    icon: Heart,
    title: "Weddings",
    description: "Create magical wedding moments with our comprehensive planning and design services.",
  },
  {
    icon: Briefcase,
...
export function ServicesCarouselSection() {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: 'url("/event-venue-background.jpg")',
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="relative">
                ...
                <div key={slideIndex} className="w-full flex-shrink-0 flex gap-6 px-4">
                  {services.slice(slideIndex * itemsPerView, (slideIndex + 1) * itemsPerView).map((service, idx) => {
                    ...
                    return (
                      <div
                        key={service.title}
                        className="flex-1 bg-white/10 backdrop-blur-md rounded-2xl p-8 text-center text-white hover:bg-white/20 transition-all duration-300 hover:translate-y-[-10px] hover:shadow-2xl"
                        style={{
          ...
          <button
            onClick={handlePrev}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-6 z-20 p-3 bg-primary text-white rounded-full hover:bg-accent transition-colors"
          ...
          <button
            onClick={handleNext}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-6 z-20 p-3 bg-primary text-white rounded-full hover:bg-accent transition-colors"
