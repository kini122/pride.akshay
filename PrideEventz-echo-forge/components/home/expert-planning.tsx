...
export function ExpertPlanning() {
  return (
    <section className="bg-background" style={{ padding: "80px 16px 140px" }}>
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          {/* Left Column - Features */}
          <div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl tracking-tight font-bold text-foreground mb-12">
