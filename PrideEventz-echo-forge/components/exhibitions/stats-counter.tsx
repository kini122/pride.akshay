...
function CountUpNumber({ target, suffix }: { target: number; suffix: string }) {
  ...
  return (
    <div ref={ref} className="text-center">
      <p className="text-3xl md:text-4xl lg:text-5xl tracking-tight lg:text-6xl tracking-tight font-bold text-white mb-2">
  ...
  return (
    <section className="py-24 md:py-32 px-4 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/exhibitions/statistics/busy-exhibition-hall.jpg')",
        }}
      >
